...
const required=[
  '<title>Greek Conversation App</title>',
  '<div class="title">Greek Conversation App</div>',
...
if(!manifest.includes('Greek Conversation App')){console.error('Manifest app name missing'); process.exit(1);}
...
if(!sw.includes('gta-v13-4-1-polish')){console.error('Service worker cache version missing'); process.exit(1);}
...
console.log('GTA V13.4 consistency polish smoke test passed.');
