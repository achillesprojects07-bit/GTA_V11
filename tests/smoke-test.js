...
if(html.indexOf('V15.2 SINGLE AUTHORITATIVE ROUTER')<0){console.error('router missing');process.exit(1)}

// V15.2 regression guard: the single authoritative router must be present and capture-phase.
if(!html.includes('window.__go=show')){console.error('authoritative router window.__go missing');process.exit(1);}
