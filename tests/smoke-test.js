...
const required=[
  ...
  '<span class="versionMini">V15.2c</span>',
  "const APP_VERSION='V15.2c'",
  "const LS='gta_v12_state'",
  'V15.2c STABILITY SHELL',
  'gta-v15-2c-stable-tabs',
  'c0_vowels',
  "unit:'L0.01'",
  "id:'c0_gavros'",
  "unit:'L0.10'"
...
if(!sw.includes("const CACHE_NAME='gta-v15-2c-stable-tabs'")){console.error('Service worker cache mismatch');process.exit(1)}
if(!readme.includes('# Καθημερινά V15.2c')){console.error('README heading mismatch');process.exit(1)}
if(!pkg.includes('"version":"15.2.3"')){console.error('Package version mismatch');process.exit(1)}
...
console.log('Καθημερινά V15.2c Stable Tabs smoke test passed.');
