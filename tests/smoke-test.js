...
const required=[
  ...
  '<div class="title">Καθημερινά <span class="versionMini">V13.6.34</span></div>',
  "const APP_VERSION='V13.6.34'",
  ...
  'English → Greek',
  'xlateGreek',
  'gta-v13-6-34-dialogue-rehearsal-flow'
];
...
if(!sw.includes("const CACHE_NAME='gta-v13-6-34-dialogue-rehearsal-flow'")){console.error('Service worker cache mismatch');process.exit(1)}
if(!readme.includes('# Καθημερινά V13.6.34 — Dialogue Direct + Rehearsal Controls')){console.error('README heading mismatch');process.exit(1)}
if(!pkg.includes('"version":"13.6.34"')){console.error('Package version mismatch');process.exit(1)}
...
console.log('GTA V13.6.34 Dialogue Direct + Rehearsal Controls smoke test passed.');
