...
const required=[
  ...
  '<div class="title">Καθημερινά <span class="versionMini">V13.5.4</span></div>',
  "const APP_VERSION='V13.5.4'",
...
if(!sw.includes('gta-v13-5-4-capture-front-door')){console.error('Service worker cache version missing'); process.exit(1);}
...
if(!readme.includes('# Καθημερινά V13.5.4 — Conversation Capture Front Door')){console.error('README heading does not match V13.5.4 capture-front-door build'); process.exit(1);}
if(!html.includes('<div class="title">Καθημερινά <span class="versionMini">V13.5.4</span></div>')){console.error('Visible app header version does not show V13.5.4'); process.exit(1);}
if(!html.includes("const APP_VERSION='V13.5.4'")){console.error('APP_VERSION is not V13.5.4'); process.exit(1);}
if(!html.includes('<div class="integrityItem"><b>V13.5.4</b><span class="muted">Version label</span></div>')){console.error('Build Integrity panel does not show V13.5.4'); process.exit(1);}
...
console.log('GTA V13.5.4 Καθημερινά capture-front-door smoke test passed.');
