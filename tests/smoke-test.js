...
const required=[
  ...
  '<div class="title">Καθημερινά <span class="versionMini">V13.6.35</span></div>',
  "const APP_VERSION='V13.6.35'",
  ...
  'English → Greek',
  'xlateGreek',
  'gta-v13-6-35-save-to-review-fix'
];
...
if(!sw.includes("const CACHE_NAME='gta-v13-6-35-save-to-review-fix'")){console.error('Service worker cache mismatch');process.exit(1)}
if(!readme.includes('# Καθημερινά V13.6.35 — Save-to-Review Fix')){console.error('README heading mismatch');process.exit(1)}
if(!pkg.includes('"version":"13.6.35"')){console.error('Package version mismatch');process.exit(1)}
...
console.log('GTA V13.6.35 Save-to-Review Fix smoke test passed.');
