...
const required=[
  ...
  '<div class="title">Καθημερινά <span class="versionMini">V13.6.1</span></div>',
  "const APP_VERSION='V13.6.1'",
...
if(html.includes('V13.2')||html.includes('V13.3')||html.includes('V13.5.4')||html.includes('V13.5.5')||html.includes('V13.5.8')||html.includes('V13.5.9')||html.includes('V13.6.0')){console.error('Old version labels remain in index.html'); process.exit(1);}
...
if(!sw.includes('gta-v13-6-1-adaptive-session')){console.error('Service worker cache version missing'); process.exit(1);}
...
if(!readme.includes('# Καθημερινά V13.6.1 — Adaptive Daily Session')){console.error('README heading does not match V13.6.1 adaptive-session build'); process.exit(1);}
if(!html.includes('<div class="title">Καθημερινά <span class="versionMini">V13.6.1</span></div>')){console.error('Visible app header version does not show V13.6.1'); process.exit(1);}
if(!html.includes("const APP_VERSION='V13.6.1'")){console.error('APP_VERSION is not V13.6.1'); process.exit(1);}
if(!html.includes('<div class="integrityItem"><b>V13.6.1</b><span class="muted">Version label</span></div>')){console.error('Build Integrity panel does not show V13.6.1'); process.exit(1);}
...
console.log('GTA V13.6.1 Καθημερινά adaptive-session smoke test passed.');
