...
const required=[
  'GTA V13.3',
  'V13.3-on-track-progress-tracker',
...
if(!manifest.includes('GTA Greek Conversation Companion V13.3')){console.error('Manifest version missing'); process.exit(1);}
if(!sw.includes('gta-v13-3-on-track-progress-tracker')){console.error('Service worker cache version missing'); process.exit(1);}
...
console.log('GTA V13.3 on-track progress tracker smoke test passed.');
